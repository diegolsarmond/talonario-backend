...
{
    public class InfracaoEntity
    {
        #region Public Properties

        public string Abordagem { get; set; }
        public string BairroInfracao { get; set; }
        ...
        public string DataAfericao { get; set; }
        public string DataAuto { get; set; }
        ...
        public string RecolheOutros { get; set; }
        public string RecolheOutrosDados { get; set; }
        ...
        public string VeiculoOutrosDados { get; set; }
